...
st = conn.prepareStatement("update info_question set    subname='"+subname+"',programe='"+programme+"',dept='"+dept+"',sem='"+sem+"',doe='"+doe+"',subcoordi='"+subcord+"',hod='"+hod+"' where subcode='"+subcode1+"';");
