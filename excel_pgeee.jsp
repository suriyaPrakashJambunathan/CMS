...
<%response.setHeader("Content-Disposition","attachment;filename=ME_EEE_POWER_ELECTRONICS_database.xls"); %>
<%
...
rs=stmt.executeQuery("select * from REGISTERDATA  where dept='ME EEE POWER ELECTRONICS' order by regester_no");  
while(rs.next()){  
%>  
