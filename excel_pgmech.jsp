...
<%response.setHeader("Content-Disposition","attachment;filename=ME_MECH_CAD/CAM_ENGINEERING.xls"); %>
<%
...
rs=stmt.executeQuery("select * from REGISTERDATA  where dept='ME MECH CAD/CAM ENGINEERING' order by regester_no");  
while(rs.next()){  
%>  
