...
st = conn.prepareStatement("INSERT INTO model_QUESTIONS (sno,subcode) VALUES (3,?)");
...
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit3_model.jsp">
<h1>QUESTION NO 3</h1>
<h1>UPLOAD UNIT 1 PART-A 2 MARK QUESTION</h1>
