...
st = conn.prepareStatement("INSERT INTO IAT2_QUESTIONS (sno,subcode) VALUES (25,?)");
...
%>   
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit25.jsp">
