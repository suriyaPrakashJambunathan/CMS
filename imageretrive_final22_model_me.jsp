...
String id="1";
   byte[] b=null;
   try{
      String sqlImageInsertDatabase="update model_QUESTIONS set qno='22',bImage=? where sno=22 and subcode=?";
...
session.setAttribute("subcode",subcode5);
     response.sendRedirect("upload_partb_u3_16_23_model_me.jsp"); 
   }
   catch(Exception e)
   {
     e.printStackTrace();}
