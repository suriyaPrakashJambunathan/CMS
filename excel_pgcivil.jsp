...
<%response.setHeader("Content-Disposition","attachment;filename=ME_CIVIL_database.xls"); %>
<%
...
rs=stmt.executeQuery("select * from REGISTERDATA  where dept='ME CIVIL STRUCTURAL ENGINEERING' order by regester_no");  
while(rs.next()){  
%>  
