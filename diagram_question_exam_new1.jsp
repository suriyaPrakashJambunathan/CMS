...
String subname=request.getParameter("subname");
  ...
  String programme=request.getParameter("prog");     
        ...
        String dept=request.getParameter("branch"); String exam=request.getParameter("exam");
...
st = conn.prepareStatement("update info_question set    subname='"+subname+"',programe='"+programme+"',dept='"+dept+"',exam='"+exam+"',sem='"+sem+"',doe='"+doe+"',subcoordi='"+subcord+"',hod='"+hod+"' where subcode='"+subcode1+"';");
