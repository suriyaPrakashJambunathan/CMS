...
<%@page import="java.io.*"%>
 <left> <a href='index_cse.jsp'>GoBack</a></left>
...
try{
  ...
  rs=stmt.executeQuery("select username FROM tablemasterstaff WHERE username='placementcse'");
    ...
    while(rs.next())
       {
                       ...
                       if(uname.equalsIgnoreCase("placementcse"))
          {
             ...
             //out.println(RN1);
              String update="update tablemasterstaff set PASSWORD=? WHERE username='placementcse'";
