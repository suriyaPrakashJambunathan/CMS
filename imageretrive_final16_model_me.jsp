...
String id="1";
   byte[] b=null;
   try{
      String sqlImageInsertDatabase="update model_QUESTIONS set qno='16',bImage=? where sno=16 and subcode=?";
...
session.setAttribute("subcode",subcode5);
     response.sendRedirect("upload_partb_u2_8_17_model_me.jsp"); 
   }
   catch(Exception e)
   {
     e.printStackTrace();}
