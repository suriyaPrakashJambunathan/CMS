...
<a class="logo" data-analytics="site logo" href="/">
     <div align="left"  style=" font-size:20px; color:red; ">
<a href="index_staff_test_login_model_main.jsp">Go Back</a>
</div>
 <center><a href="" id="logo"><img src="images/logo1.jpg" alt="LOGO" /></a></center> <br><br>
 <center><a href="" id="logo"><img src="images/FORGOT PASSWORD.gif" alt="LOGO" /></a></center> <br><br>
</a>
</nav>
</div>
</header>
  <section class="login">
<form id="login-form" accept-charset="utf-8" method="post" action="changepassword4.jsp"> 
<h1>Enter the New Password</h1>
<input type="password" value="" placeholder="PassWord" tabindex="20" name="new">
<h1>ReEnter the New Password</h1>
<input type="password" value="" placeholder="ReEnter the PassWord" tabindex="20" name="confirm"> 
 <br><br>
