...
st = conn.prepareStatement("INSERT INTO model_QUESTIONS (sno,subcode) VALUES (2,?)");
...
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit2_model.jsp">
<h1>QUESTION NO 2</h1>
