...
<%@page import="javax.servlet.http.HttpSession"%>
 ...
 <center><a href="" id="logo"><img src="images/logo1.jpg" alt="LOGO" /></a></center> <br><br>
     <center><a href="" id="logo"><img src="images/MEMECHPGDATABASE.gif" alt="LOGO" /></a></center>    <br><br>
 <style type="text/css">
...
rs=stmt.executeQuery("select * from REGISTERDATA where dept='ME MECH CAD/CAM ENGINEERING'");  
while(rs.next()){  
...
<br><br>
 ...
 <table width='70%'><tr><td align='center'><a href='excel_pgmech.jsp'><h3>Generate Excel</h3></a></tr></table>
