...
st = conn.prepareStatement("INSERT INTO model_QUESTIONS (sno,subcode) VALUES (32,?)");
...
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit32_model.jsp">
<h1>UPLOAD THE PART-B 16 MARK QUESTION UNIT 3</h1>
