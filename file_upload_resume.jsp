...
<body>
    <%!String loc;%>
    <br><br> 
   <center> <h5><img src="images/UPLOADRESUME.gif" alt=""></h5> </center> 
  <center><br><br>  
      
     
 
        <form action="show555556" method="POST" enctype="multipart/form-data">      
            <label for="fileName"><img src="images/select.gif" alt=""> </label>
            <input id="fileid" type="file" name="fileName" /><br><br><br><br>             
          <input id="one" type="submit" value="UPLOAD" /><br><br><br><br><br><br><br><br>     
          <a href="index_resume_delete.jsp"><h1>DELETE LINK<h1></a>
