...
st = conn.prepareStatement("INSERT INTO model_QUESTIONS (sno,subcode) VALUES (19,?)");
...
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit19_model.jsp">
<h1>UPLOAD THE PART-A 2 MARK QUESTION UNIT 5</h1>
