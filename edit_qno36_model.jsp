...
st = conn.prepareStatement("INSERT INTO model_QUESTIONS (sno,subcode) VALUES (36,?)");
...
%> 
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit36_model.jsp">
<h1>UPLOAD THE PART-B 16 MARK QUESTION UNIT 4</h1>
