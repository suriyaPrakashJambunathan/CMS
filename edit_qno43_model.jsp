...
st = conn.prepareStatement("INSERT INTO model_QUESTIONS (sno,subcode) VALUES (43,?)");
...
%> 
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit43_model.jsp">
<h1>UPLOAD THE PART-B 16 MARK QUESTION UNIT 5</h1>
