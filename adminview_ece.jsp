...
<%@page import="javax.servlet.http.HttpSession"%>
 ...
 <center><a href="" id="logo"><img src="images/logo1.jpg" alt="LOGO" /></a></center> <br><br>
     <center><a href="" id="logo"><img src="images/ECEUGDATABASE.gif" alt="LOGO" /></a></center>    <br><br>
 <style type="text/css">
...
rs=stmt.executeQuery("select * from REGISTERDATA where dept='ECE'");  
while(rs.next()){  
...
<td><%= rs.getString(18) %></td>
 </td><td><a href='editece.jsp?id=<%=rs.getString(1)%>'>Edit</a></td> 
</tr>  
...
<br><br>
 ...
 <table width='70%'><tr>
           <td align='center'><a href='excel_ece.jsp'><h3>Generate Excel</h3></a></tr></table>
