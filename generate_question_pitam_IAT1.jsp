...
<table width='100%'><tr><td align='left'><a href='index_admin_examIAT1.jsp'><h3>Goback</h3></a></td>
...
</td><td><a href='generate_question_image_IAT1.jsp?id=<%=rs.getString(1)%>'>Generate Question Paper</a></td>
</tr>  
