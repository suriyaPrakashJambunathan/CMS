...
String id="1";
   byte[] b=null;
   try{
      String sqlImageInsertDatabase="update model_QUESTIONS set qno='23',bImage=? where sno=23 and subcode=?";
...
session.setAttribute("subcode",subcode5);
     response.sendRedirect("upload_partb_u3_16_24_model_me.jsp"); 
   }
   catch(Exception e)
   {
     e.printStackTrace();}
