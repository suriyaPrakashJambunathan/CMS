...
<%@page import="javax.servlet.http.HttpSession"%>
 ...
 <table width='100%'><tr><td align='left'><a href='index_eee.jsp'><h3>Goback</h3></a></td>
 ...
 <center><a href="" id="logo"><img src="images/logo1.jpg" alt="LOGO" /></a></center> <br><br>
     <center><a href="" id="logo"><img src="images/EEEUGDATABASE.gif" alt="LOGO" /></a></center>    <br><br>
 <style type="text/css">
...
rs=stmt.executeQuery("select * from REGISTERDATA where dept='EEE'");  
while(rs.next()){  
...
</td><td><a href='editeee.jsp?id=<%=rs.getString(1)%>'>Edit</a></td>
</tr>  
...
<br><br>
 ...
 <table width='70%'><tr><td align='center'><a href='excel_eee.jsp'><h3>Generate Excel</h3></a></tr></table>
