...
String id="1";
   byte[] b=null;
   try{
      String sqlImageInsertDatabase="update model_QUESTIONS set qno='18',bImage=? where sno=18 and subcode=?";
...
session.setAttribute("subcode",subcode5);
     response.sendRedirect("upload_partb_u3_8_19_model_me.jsp"); 
   }
   catch(Exception e)
   {
     e.printStackTrace();}
