...
<table  class="myTable">  
<tr><th>SUBJECT CODE</th><th>SUBJECT NAME</th><th>PROGRAMME</th><th>DEPARTMENT</th><th>EXAM</th><th>SEMESTER</th><th>DATE OF EXAM</th><th>STAFF NAME I</th><th>STAFF NAME II</th>  
    <th>HOD NAME</th>
</tr>  
...
rs=stmt.executeQuery("select * from internal_assessment");  
while(rs.next()){  
...
</td><td><a href='generate_question.jsp?id=<%=rs.getString(1)%>'>Generate Question Paper</a></td>
</tr>  
