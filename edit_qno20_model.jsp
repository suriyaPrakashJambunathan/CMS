...
st = conn.prepareStatement("INSERT INTO model_QUESTIONS (sno,subcode) VALUES (20,?)");
...
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit20_model.jsp">
