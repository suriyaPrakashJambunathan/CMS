...
<%@page import="java.sql.*"%>
 ...
 <table width='100%'><tr><td align='left'><a href='index_principal.jsp'><h3>Goback</h3></a></td>
 ...
 <center><a href="" id="logo"><img src="images/logo1.jpg" alt="LOGO" /></a></center> <br><br>
     <center><a href="" id="logo"><img src="images/OVERALL DATABASE.gif" alt="LOGO" /></a></center>    <br><br>
 <style type="text/css">
...
rs=stmt.executeQuery("select * from REGISTERDATA");  
while(rs.next()){  
...
<br><br>
 ...
 <table width='70%'><tr><td align='left'><a href='sort_principal.jsp'><h3>Sort the Table</h3></a></td>
           <td align='center'><a href='excel.jsp'><h3>Generate Excel</h3></a></tr></table>
