...
<%response.setHeader("Content-Disposition","attachment;filename=mba_database.xls"); %>
<%
...
rs=stmt.executeQuery("select * from REGISTERDATA  where dept='mba' order by regester_no");  
while(rs.next()){  
%>  
