...
<table  class="myTable">  
<tr><th>SUBJECT CODE</th><th>SUBJECT NAME</th><th>PROGRAMME</th><th>DEPARTMENT</th><th>EXAM</th><th>SEMESTER</th><th>DATE OF EXAM</th><th>SUBJECT COORDINATOR</th>  
...
rs=stmt.executeQuery("select * from info_questionMODEL");  
while(rs.next()){  
...
</td><td><a href='edit_question_image_model.jsp?id=<%=rs.getString(1)%>'>Edit Question</a></td>
</tr>  
