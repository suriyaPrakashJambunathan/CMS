...
<%@page import="javax.servlet.http.HttpSession"%>
 ...
 <table width='100%'><tr><td align='left'><a href='index_cse.jsp'><h3>Goback</h3></a></td>
 ...
 <center><a href="" id="logo"><img src="images/logo1.jpg" alt="LOGO" /></a></center> <br><br>
     <center><a href="" id="logo"><img src="images/CSEUGDATABASE.gif" alt="LOGO" /></a></center>    <br><br>
 <style type="text/css">
...
rs=stmt.executeQuery("select * from REGISTERDATA where dept='cse'");  
while(rs.next()){  
...
</td><td><a href='editcse.jsp?id=<%=rs.getString(1)%>'>Edit</a></td>  
</tr>  
...
<br><br>
 ...
 <table width='70%'><tr><td align='center'><a href='excel_cse.jsp'><h3>Generate Excel</h3></a></tr></table>
