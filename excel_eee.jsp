...
<%response.setHeader("Content-Disposition","attachment;filename=eee_database.xls"); %>
<%
...
rs=stmt.executeQuery("select * from REGISTERDATA  where dept='eee' order by regester_no");  
while(rs.next()){  
%>  
