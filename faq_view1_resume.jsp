...
<a href="index_stud_main.jsp">Go Back</a>
</div>
...
<body>
    ...
    <%  String path = getServletContext().getRealPath( "//images//resume//");
...
if( s.equalsIgnoreCase(files[ii].getName())){ %>
    ...
    <center><iframe src="images//resume//<%=files[ii].getName()%>" height="1030" width="1040"></iframe></center> 
<%}}%>
