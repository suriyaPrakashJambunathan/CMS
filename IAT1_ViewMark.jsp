...
while(rs1.next()){
%>
 <tr><th>SUBJECT CODE</th><td><%=subcode11%></td><th>SUBJECT NAME</th><td><%=rs1.getString(4)%></td><tr>
...
</table><tr><td><a href='EDIT_IAT1_ViewMark.jsp?subcode=<%=subcode11%>&amp;dept=<%=dept11%>'><h3>Edit Marks</h3></a></td></tr> 
</center>
</form><%
