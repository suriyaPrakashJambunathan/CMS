...
a {
    ...
    transition: color 0.2s ease 0s;
     ...
     <%
String subcode3=(String) session.getAttribute("subcode2");
...
st = conn.prepareStatement("INSERT INTO model_QUESTIONS (sno,subcode) VALUES (1,?)");
...
%> 
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit_model.jsp">
<h1>UPLOAD THE PART-A 2 MARK QUESTION UNIT 1</h1>
