...
st = conn.prepareStatement("INSERT INTO IAT1_QUESTIONS (sno,subcode) VALUES (13,?)");
...
%>      
<form id="login-form" name="pitam" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="imageretrive_edit13_IAT1.jsp">
