...
rs2=stmt1.executeQuery("select * from view_mark_admin_re1 where dept='"+dept11+"'"); 
...
rs2=stmt1.executeQuery("select a.regno,a.name,b.dept,b.subcode,b.subname,b.test,b.mark from TEST_STUD a,Student_Mark_entry_1_re1 b where b.subcode='"+s5+"' and a.dept='"+s1+"' and a.batch='"+s2+"' and a.sem='"+s3+"' and b.test='"+s4+"' and a.regno=b.regno"); 
while(rs2.next())
{
...
rs2=stmt1.executeQuery("select a.regno,a.name,b.dept,b.subcode,b.subname,b.test,b.mark from TEST_STUD a,Student_Mark_entry_1_re1 b where b.subcode='"+s6+"' and a.dept='"+s1+"' and a.batch='"+s2+"' and a.sem='"+s3+"' and b.test='"+s4+"' and a.regno=b.regno"); 
while(rs2.next())
{
...
rs2=stmt1.executeQuery("select a.regno,a.name,b.dept,b.subcode,b.subname,b.test,b.mark from TEST_STUD a,Student_Mark_entry_1_re1 b where b.subcode='"+s7+"' and a.dept='"+s1+"' and a.batch='"+s2+"' and a.sem='"+s3+"' and b.test='"+s4+"' and a.regno=b.regno"); 
while(rs2.next())
{
...
rs2=stmt1.executeQuery("select a.regno,a.name,b.dept,b.subcode,b.subname,b.test,b.mark from TEST_STUD a,Student_Mark_entry_1_re1 b where b.subcode='"+s8+"' and a.dept='"+s1+"' and a.batch='"+s2+"' and a.sem='"+s3+"' and b.test='"+s4+"' and a.regno=b.regno"); 
while(rs2.next())
{
...
rs2=stmt1.executeQuery("select a.regno,a.name,b.dept,b.subcode,b.subname,b.test,b.mark from TEST_STUD a,Student_Mark_entry_1_re1 b where b.subcode='"+s9+"' and a.dept='"+s1+"' and a.batch='"+s2+"' and a.sem='"+s3+"' and b.test='"+s4+"' and a.regno=b.regno"); 
while(rs2.next())
{
...
rs2=stmt1.executeQuery("select a.regno,a.name,b.dept,b.subcode,b.subname,b.test,b.mark from TEST_STUD a,Student_Mark_entry_1_re1 b where b.subcode='"+s10+"' and a.dept='"+s1+"' and a.batch='"+s2+"' and a.sem='"+s3+"' and b.test='"+s4+"' and a.regno=b.regno"); 
while(rs2.next())
{
...
rs2=stmt1.executeQuery("select a.regno,a.name,b.dept,b.subcode,b.subname,b.test,b.mark from TEST_STUD a,Student_Mark_entry_1_re1 b where b.subcode='"+s11+"' and a.dept='"+s1+"' and a.batch='"+s2+"' and a.sem='"+s3+"' and b.test='"+s4+"' and a.regno=b.regno"); 
while(rs2.next())
{
...
rs2=stmt1.executeQuery("select Tot_no_stud,Stud_Abse,Stud_Pres,Stud_pass,Stud_Fail,Pass_Perc,Fail_Perc from calculation_marks_re1 where subcode='"+s5+"' AND dept='"+s1+"'"); 
while(rs2.next())
...
rs2=stmt1.executeQuery("select Tot_no_stud,Stud_Abse,Stud_Pres,Stud_pass,Stud_Fail,Pass_Perc,Fail_Perc from calculation_marks_re1 where subcode='"+s6+"' AND dept='"+s1+"'"); 
while(rs2.next())
...
rs2=stmt1.executeQuery("select Tot_no_stud,Stud_Abse,Stud_Pres,Stud_pass,Stud_Fail,Pass_Perc,Fail_Perc from calculation_marks_re1 where subcode='"+s7+"' AND dept='"+s1+"'"); 
while(rs2.next())
...
rs2=stmt1.executeQuery("select Tot_no_stud,Stud_Abse,Stud_Pres,Stud_pass,Stud_Fail,Pass_Perc,Fail_Perc from calculation_marks_re1 where subcode='"+s8+"' AND dept='"+s1+"'"); 
while(rs2.next())
...
rs2=stmt1.executeQuery("select Tot_no_stud,Stud_Abse,Stud_Pres,Stud_pass,Stud_Fail,Pass_Perc,Fail_Perc from calculation_marks_re1 where subcode='"+s9+"' AND dept='"+s1+"'"); 
while(rs2.next())
...
rs2=stmt1.executeQuery("select Tot_no_stud,Stud_Abse,Stud_Pres,Stud_pass,Stud_Fail,Pass_Perc,Fail_Perc from calculation_marks_re1 where subcode='"+s10+"' AND dept='"+s1+"'"); 
while(rs2.next())
...
rs2=stmt1.executeQuery("select Tot_no_stud,Stud_Abse,Stud_Pres,Stud_pass,Stud_Fail,Pass_Perc,Fail_Perc from calculation_marks_re1 where subcode='"+s11+"' AND dept='"+s1+"'"); 
while(rs2.next())
...
%></table> <table>
</td><td><a href='excel_mark_consolidated1.jsp?dept=<%=s1%>'>Generate Excel</a></td>
</table> 
</center>
</form>