...
st = conn.prepareStatement("update info_questionIAT1 set    subname='"+subname+"',programe='"+programme+"',dept='"+dept+"',sem='"+sem+"',doe='"+doe+"',subcoordi='"+subcord+"',hod='"+hod+"' where subcode='"+subcode1+"';");
...
st.executeUpdate();
     ...
     response.sendRedirect("index_staff_test_loginIAT1.jsp");
