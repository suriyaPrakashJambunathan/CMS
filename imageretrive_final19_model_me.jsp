...
String id="1";
   byte[] b=null;
   try{
      String sqlImageInsertDatabase="update model_QUESTIONS set qno='19',bImage=? where sno=19 and subcode=?";
...
session.setAttribute("subcode",subcode5);
     response.sendRedirect("upload_partb_u2_16_20_model_me.jsp"); 
   }
   catch(Exception e)
   {
     e.printStackTrace();}
