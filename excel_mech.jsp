...
<%response.setHeader("Content-Disposition","attachment;filename=mech_database.xls"); %>
<%
...
rs=stmt.executeQuery("select * from REGISTERDATA  where dept='mech' order by regester_no");  
while(rs.next()){  
%>  
